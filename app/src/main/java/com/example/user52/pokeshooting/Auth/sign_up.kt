 ...
 * [sign_up.OnFragmentInteractionListener] interface
...
class sign_up : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_register.setOnClickListener {register(it) }
    }

    fun register(uri: View){
        listener?.onRegisterClicked(uri)
    }
    ...
    interface OnFragmentInteractionListener {
        ...
        fun onRegisterClicked(uri: View)
    }
